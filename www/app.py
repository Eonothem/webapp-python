...
def response_factory(app, handler):
	...
	def response(request):
		...
		resp = web.Response(body=str(r).encode('utf-8'))#others
...
def init(loop):
	...
	app = web.Application(loop=loop, middlewares=[logger_factory, auth_factory, response_factory])#to build a http server through aiohttp
